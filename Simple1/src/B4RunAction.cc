...
{ 
    ...
    // Creating histograms                              bins  left right
    analysisManager->CreateH1("1","Edep in absorber",   100,  0.,  10*MeV );
    analysisManager->CreateH1("2","Edep in gap",        100,  0.,  10*MeV );
    analysisManager->CreateH1("3","trackL in absorber", 100,  0.,  1*m     );
    analysisManager->CreateH1("4","trackL in gap",      100,  0.,  50*cm   );

    // New branch
    analysisManager->CreateH1("5","Edep in entire cal", 100,  0.,  10*MeV);
